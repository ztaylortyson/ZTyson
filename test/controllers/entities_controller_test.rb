...
class EntitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create entity" do
    assert_difference("Entity.count") do
      post entities_url, params: { entity: { agentsp: @entity.agentsp, dba: @entity.dba, owner: @entity.owner, status: @entity.status } }
    end
  ...
  test "should update entity" do
    patch entity_url(@entity), params: { entity: { agentsp: @entity.agentsp, dba: @entity.dba, owner: @entity.owner, status: @entity.status } }
